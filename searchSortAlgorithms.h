...
template <class elemType>
void quickSortWithInsertionSort(elemType list[], int length)
{
	recQuickSort20(list, 0, length - 1);
}

template <class elemType>
void recQuickSort20(elemType list[], int first, int last)
{
	int pivotLocation;
	...
	if (last-first > 20)
	{
		...
		insertionSort20(list, first, last);
}

template <class elemType>
void insertionSort20(elemType list[], int first, int last)
{
	int unsortedIndex, location;
	elemType temp;

	for (unsortedIndex = first + 1; unsortedIndex <= last; 
								   unsortedIndex++)
...
template<class elemType>
void quickSortMedianPivot(elemType list[], int length)
{
...
template <class elemType>
int medianLoc(elemType list[], int first, int middle, int last)
{
...
template <class elemType>
void quickSortMedianWithInsertionSort(elemType list[], int length)
{
	recQuickSortMedian20(list, 0, length - 1);
}

template <class elemType>
void recQuickSortMedian20(elemType list[], int first, int last)
{
	int pivotLocation;
